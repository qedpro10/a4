...
@section('content')
    ...
    <div class="row">
        <div class="col col-md-5">
            ...
            <p>End of day Email notifications are available to provide stock trade suggestions.</p>
        </div>
        <div class="col col-md-5">
            <blockquote cite='www.themarketguys.com'>
            ...
            <p>Register to get started now</p>
            <ul>
